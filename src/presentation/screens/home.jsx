...
const Home = () => {
  ...
  let currentTime =
    CurrentDateandTime.split(",")[1] + " " + CurrentDateandTime.split(",")[0];
  ...
  let data = JSON.stringify({
    printContent: [
      ...
      {
        LineItem: mappedSlip[0]?.slipGame,
        FontSize: 8,
        Bold: true,
        Alignment: 0,
        NewLine: true,
      ...
      {
        LineItem: "Br " + mappedSlip[0]?.slipAmount,
        FontSize: 8,
        Bold: true,
        Alignment: 2,
        NewLine: false,
      ...
      {
        LineItem:
          mappedSlip[0]?.slipGameType +
          mappedSlip[0]?.slipDate +
          "#" +
          mappedSlip[0]?.slipGameId,
        FontSize: 8,
        Bold: false,
        Alignment: 0,
        NewLine: true,
      ...
      {
        LineItem: mappedSlip[0]?.slipValue,
        FontSize: 8,
        Bold: false,
        Alignment: 0,
        NewLine: true,
      ...
      {
        LineItem: "Etvirtual Standard Terms and Conditions Apply",
        FontSize: 5,
        Bold: false,
        Alignment: 1,
        NewLine: true,
  ...
  const handlebetPlaceResponse = async () => {
    ...
    try {
      ...
      if (response.payload) {
        localStorage.setItem("slipResponse", JSON.stringify(response.payload));
        setBetSuccess(true);
          ...
          {slips.length > 0 ? (
            <>
              {slips.map((slip) => {
                return (
                  <div
                    className="w-full flex flex-col text-[0.7rem] bg-slipGray p-0.5 rounded-md text-white"
                    key={slip.date}
                  >
