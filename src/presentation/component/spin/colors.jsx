  ...
  return (
    <div className="flex">
      <div
        ...
        onClick={() => handleClick("sectors", "32/15/19/4/21/2")}
        style={{
          cursor: "pointer",
          position: "relative",
          width: "140px",
      ...
      <div
        ...
        onMouseLeave={() => removeColor()}
        onClick={() => handleClick("sectors", "25/17/34/6/27/13")}
        style={{
          cursor: "pointer",
          position: "relative",
          width: "140px",
      ...
      <div
        ...
        onMouseLeave={() => removeColor()}
        onClick={() => handleClick("sectors", "36/11/30/8/23/10")}
        style={{
          cursor: "pointer",
          position: "relative",
          width: "140px",
      ...
      <div
        ...
        onMouseLeave={() => removeColor()}
        onClick={() => handleClick("sectors", "5/24/16/33/1/20")}
        style={{
          cursor: "pointer",
          position: "relative",
          width: "140px",
      ...
      <div
        ...
        onMouseLeave={() => removeColor()}
        onClick={() => handleClick("sectors", "14/31/9/22/18/9")}
        style={{
          cursor: "pointer",
          position: "relative",
          width: "140px",
      ...
      <div
        ...
        onMouseLeave={() => removeColor()}
        onClick={() => handleClick("sectors", "7/28/12/35/3/26")}
        style={{
          cursor: "pointer",
          position: "relative",
          width: "140px",
