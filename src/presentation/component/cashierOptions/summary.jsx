  ...
  const handleRefresh = async () => {
    try {
      const response = await dispatch(
        getReportAction(
          selectedDateFrom.toISOString(),
          selectedDateTo.toISOString()
        )
      );
      if (response.payload) {
    ...
    <div className="w-full p-4 border-green-500 border-[1px] text-[0.8rem]">
      ...
      <div className="flex flex-col gap-5 w-full p-2 border-grey-500 border-[1px]">
        ...
        <div className="flex justify-end w-full">
          <p>
            Report Date: <span>21/11/2023 07:09:23</span>
          </p>
        </div>
        ...
        <div className="flex items-center justify-center mt-4">
          <div className="w-[40px] h-[40px] flex justify-center items-center border cursor-pointer rounded-full">
